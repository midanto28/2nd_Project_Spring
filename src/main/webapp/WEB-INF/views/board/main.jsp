...
<body class="d-flex flex-column">
	<main class="flex-shrink-0">
				...
				<div class="search">
					<div class="input-group">
						<input type="text" class="form-control" size="50"
							id="searchKey" placeholder="다른뉴스를 검색하세요" required>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link"
							href="/board/register">Write</a></li>
		...
		<!-- 검색내용 보여주는 곳 -->
		<section class="py-5 bg-light"  id="searchSection">
                <div class="container px-5">
                    <div class="row gx-5">
                            ...
                            <div class="text-end mb-5 mb-xl-0">
                                <a class="text-decoration-none" href="/board/main">
                                   	검색결과 닫기
						...
						<div class="row gx-0">
							<div class="col-lg-6 col-xl-5 py-lg-5">
								<div class="p-4 p-md-5">
									<div class="h2 fw-bolder">${main.title}</div>
									<c:if test="${not empty main}">
										<a class="stretched-link text-decoration-none"
											href="/board/read?pno=${main.pno}"> Read more <i
							...
							<div class="col-lg-6 col-xl-7">
								<div class="bg-featured-blog"
									style="background-image: url('/resources/upload/${main.img}');height: 350px; background-size:100% 100%;"></div>
							</div>
						</div>
					</div>
				</div>
					...
					<c:forEach var="story" items="${list}">
						<div class="col-lg-4 mb-5">
							<div class="card h-100 shadow border-0">
								<img class="card-img-top" src="/resources/upload/${story.img}"
									alt="Image" style="height: 250px; object-fit: cover;" />
								<div class="card-body p-4">
									<a class="text-decoration-none link-dark stretched-link"
										href="/board/read?pno=${story.pno}">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<form id="searchForm" method="get" class="input-group mb-2">
							...
							<input name="keyword" class="form-control"> <input
    	...
    	$(document).ready(function(){	
    		...
    		$(function() {
    		    $('#searchBtn').click(function() {
    		      ...
    		      $.ajax({
    		        url : "/board/search",  	// 요청 URL
    		        type : "get",                  // HTTP 메서드(전송방식)
    		        data : {                       // 매개변수로 전달할 데이터
    		            keyword : $('#searchKey').val(),                   // 검색어
    		        },
    		...
    		// 검색 성공 시 결과를 화면에 뿌려줍니다.
		 	function sucFuncJson(d) {
			    ...
			    $.each(d.items, function(index, item) {
			        str += "<div class='mb-4'>";
			        str += "    <div class='small text-muted'>" + item.pubDate + "</div>";
